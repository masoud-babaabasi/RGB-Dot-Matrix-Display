...
xst -ifn xst.scr
move Clock_genarator_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock_genarator_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock_genarator_exdes.ucf Clock_genarator_exdes

echo 'Running map'
map -timing -pr b Clock_genarator_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Clock_genarator_exdes -w routed.ncd routed.v
cd ..
